...
next_nearerto_zero(x::Float32)   = muladd(0.99999994f0, x, -1.435f-42)       # (x-5.960465f-8*x)-1.435f-42
next_awayfrom_zero(x::Float32)   = muladd(1.00000010f0, x, +1.435f-42)       # (x+5.960465f-8*x)+1.435f-42
